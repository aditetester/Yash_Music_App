...
class _HomeScreenState extends State<HomeScreen> {
 ...
 // Body methods:-----------------------------------------------------------
  Widget _builderCategories(BuildContext context) {
    return Container(
      child: Column(
        children: [
          Row(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount: 2, // Example data count
                ...
                return Container(
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.headphones, color: Colors.white, size: 48),
                        SizedBox(height: 8),
                        Text(
                          "Music",
                          style: TextStyle(
