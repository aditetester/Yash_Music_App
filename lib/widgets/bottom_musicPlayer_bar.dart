...
class BottomMusicPlayerBar extends StatefulWidget {
  ...
  @override
  State<BottomMusicPlayerBar> createState() => _BottomMusicPlayerBarState();
}
...
class _BottomMusicPlayerBarState extends State<BottomMusicPlayerBar> {
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) {
        final image = widget.musicControllerStore.recentMusic.image.toString();
        if (image.isEmpty) {
              ...
              widget.isTapEnable
                  ? () {
                    Navigator.of(context).pushNamed(
                      Routes.musicPlayer,
                      arguments: widget.musicControllerStore.recentMusic,
                    );
                  }
                  : () {},
          child: BottomAppBar(
                    ...
                    children: [
                                ...
                                child: Observer(
                                  builder: (context) {
                                    ...
                                    if (_formatDuration(currentPosition) ==
                                      ...
                                      widget.musicControllerStore.playNext(
                                        currentIndex:
                                            (widget
                                                            .musicControllerStore
                                                            .AllMusic!
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget.musicControllerStore.recentMusic.title
                                  .toString(),
                            ...
                            Text(
                              widget.musicControllerStore.recentMusic.subtitle
                                  .toString(),
                              style: const TextStyle(
