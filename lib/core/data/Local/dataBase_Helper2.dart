...
class MusicPlayListDBHelper {
  static MusicPlayListDBHelper? _databaseHelper; // Singleton DatabaseHelper
  ...
  MusicPlayListDBHelper._createInstance(); // Named constructor to create instance of DatabaseHelper

  MusicPlayListDBHelper() {
    if (_databaseHelper == null) {
      _databaseHelper =
          MusicPlayListDBHelper._createInstance(); // This is executed only once, singleton object
    }
  }

  Future<MusicPlayListDBHelper> get databaseHelper async {
    if (_databaseHelper == null) {
      _databaseHelper =
          MusicPlayListDBHelper._createInstance(); // This is executed only once, singleton object
    }
  ...
  Future<int> getCount() async {
    ...
    List<Map<String, dynamic>> x = await db.rawQuery(
      'SELECT COUNT (*) from $_MusicPlayListTable',
    );
