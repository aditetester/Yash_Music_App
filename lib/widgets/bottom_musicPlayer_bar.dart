...
class BottomMusicPlayerBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Observer(
      builder: (_) {
        final image = musicControllerStore.recentMusic.image.toString();
        if (image.isEmpty) {
        ...
        return GestureDetector(
          onTap: () {
             Navigator.of(context).pushNamed(Routes.musicPlayer, arguments:  musicControllerStore.recentMusic);
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              musicControllerStore.recentMusic.title.toString(),
                            ...
                            Text(
                              musicControllerStore.recentMusic.subtitle
                                  .toString(),
                              style: const TextStyle(
